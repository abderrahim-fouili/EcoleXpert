...
final class AdjustedTimeMark implements TimeMark {
    ...
    public final long m1453getAdjustmentUwyO8pc() {
    ...
    public long mo1450elapsedNowUwyO8pc() {
        return Duration.m1493minusLRDsOJo(this.mark.mo1450elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo1452plusLRDsOJo(long j) {
        return new AdjustedTimeMark(this.mark, Duration.m1494plusLRDsOJo(this.adjustment, j), null);
    }
}
