...
public final class StreamsKt {
    public static /* synthetic */ Spliterator $r8$lambda$mT0hlWR9wAJmc_Z5R4QxxU3x160(Sequence sequence) {
        return m1437asStream$lambda4(sequence);
    }
    ...
    public static final <T> Stream<T> asStream(final Sequence<? extends T> sequence) {
        ...
        Stream<T> stream = StreamSupport.stream(new Supplier() { // from class: kotlin.streams.jdk8.StreamsKt$$ExternalSyntheticLambda0
            ...
            public final Object get() {
                return StreamsKt.$r8$lambda$mT0hlWR9wAJmc_Z5R4QxxU3x160(sequence);
            }
        }, 16, false);
    ...
    public static final Spliterator m1437asStream$lambda4(Sequence this_asStream) {
