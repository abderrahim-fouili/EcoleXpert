...
public class DelegatingScheduledExecutorService implements ScheduledExecutorService {
    ...
    public /* synthetic */ ScheduledFuture m76x1338b4cd(final Runnable runnable, long j, TimeUnit timeUnit, final DelegatingScheduledFuture.Completer completer) {
    ...
    public /* synthetic */ void m75x3777390c(final Runnable runnable, final DelegatingScheduledFuture.Completer completer) {
    ...
    public /* synthetic */ ScheduledFuture m78xa67d2810(final Callable callable, long j, TimeUnit timeUnit, final DelegatingScheduledFuture.Completer completer) {
    ...
    public /* synthetic */ Future m77xcabbac4f(final Callable callable, final DelegatingScheduledFuture.Completer completer) throws Exception {
    ...
    public /* synthetic */ ScheduledFuture m80xa2ce000c(final Runnable runnable, long j, long j2, TimeUnit timeUnit, final DelegatingScheduledFuture.Completer completer) {
    ...
    public /* synthetic */ void m79xc70c844b(final Runnable runnable, final DelegatingScheduledFuture.Completer completer) {
    ...
    public /* synthetic */ ScheduledFuture m82x88d94906(final Runnable runnable, long j, long j2, TimeUnit timeUnit, final DelegatingScheduledFuture.Completer completer) {
    ...
    public /* synthetic */ void m81xad17cd45(final Runnable runnable, final DelegatingScheduledFuture.Completer completer) {
