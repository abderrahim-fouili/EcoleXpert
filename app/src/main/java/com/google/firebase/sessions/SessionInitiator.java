...
public final class SessionInitiator {
    ...
    public SessionInitiator(TimeProvider timeProvider, CoroutineContext backgroundDispatcher, SessionInitiateListener sessionInitiateListener, SessionsSettings sessionsSettings, SessionGenerator sessionGenerator) {
        ...
        this.backgroundTime = timeProvider.mo122elapsedRealtimeUwyO8pc();
        initiateSession();
    ...
    public final void appBackgrounded() {
        this.backgroundTime = this.timeProvider.mo122elapsedRealtimeUwyO8pc();
    }

    public final void appForegrounded() {
        if (Duration.m1457compareToLRDsOJo(Duration.m1493minusLRDsOJo(this.timeProvider.mo122elapsedRealtimeUwyO8pc(), this.backgroundTime), this.sessionsSettings.m125getSessionRestartTimeoutUwyO8pc()) > 0) {
            initiateSession();
        }
    }
