...
public final class EventGDTLogger implements EventGDTLoggerInterface {
    ...
    public static /* synthetic */ byte[] $r8$lambda$W13Olas0VV9EajY9qS9yOYVUJPs(EventGDTLogger eventGDTLogger, SessionEvent sessionEvent) {
    ...
    public void log(SessionEvent sessionEvent) {
        ...
        this.transportFactoryProvider.get().getTransport(AQS_LOG_SOURCE, SessionEvent.class, Encoding.of("json"), new Transformer() { // from class: com.google.firebase.sessions.EventGDTLogger$$ExternalSyntheticLambda0
            {
                EventGDTLogger.this = this;
            }

            @Override // com.google.android.datatransport.Transformer
            public final Object apply(Object obj) {
                return EventGDTLogger.$r8$lambda$W13Olas0VV9EajY9qS9yOYVUJPs(EventGDTLogger.this, (SessionEvent) obj);
            }
