...
public final class SessionsSettings {
    ...
    public final long m125getSessionRestartTimeoutUwyO8pc() {
        Duration mo123getSessionRestartTimeoutFghU774 = this.localOverrideSettings.mo123getSessionRestartTimeoutFghU774();
        if (mo123getSessionRestartTimeoutFghU774 != null) {
            long m1512unboximpl = mo123getSessionRestartTimeoutFghU774.m1512unboximpl();
            if (m124isValidSessionRestartTimeoutLRDsOJo(m1512unboximpl)) {
                return m1512unboximpl;
            }
        }
        Duration mo123getSessionRestartTimeoutFghU7742 = this.remoteSettings.mo123getSessionRestartTimeoutFghU774();
        if (mo123getSessionRestartTimeoutFghU7742 != null) {
            long m1512unboximpl2 = mo123getSessionRestartTimeoutFghU7742.m1512unboximpl();
            if (m124isValidSessionRestartTimeoutLRDsOJo(m1512unboximpl2)) {
                return m1512unboximpl2;
            }
        }
    ...
    private final boolean m124isValidSessionRestartTimeoutLRDsOJo(long j) {
        return Duration.m1492isPositiveimpl(j) && Duration.m1487isFiniteimpl(j);
    }
