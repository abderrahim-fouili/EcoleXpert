...
public class FirebaseMessaging {
    ...
    FirebaseMessaging(FirebaseApp firebaseApp, FirebaseInstanceIdInternal firebaseInstanceIdInternal, FirebaseInstallationsApi firebaseInstallationsApi, TransportFactory transportFactory2, Subscriber subscriber, Metadata metadata, GmsRpc gmsRpc, Executor executor, Executor executor2, Executor executor3) {
        ...
        if (firebaseInstanceIdInternal != null) {
            firebaseInstanceIdInternal.addNewTokenListener(new FirebaseInstanceIdInternal.NewTokenListener() { // from class: com.google.firebase.messaging.FirebaseMessaging$$ExternalSyntheticLambda2
                ...
                public final void onNewToken(String str) {
                    FirebaseMessaging.this.m110lambda$new$0$comgooglefirebasemessagingFirebaseMessaging(str);
                }
            });
        }
        executor2.execute(new Runnable() { // from class: com.google.firebase.messaging.FirebaseMessaging$$ExternalSyntheticLambda3
            ...
            public final void run() {
                FirebaseMessaging.this.m111lambda$new$1$comgooglefirebasemessagingFirebaseMessaging();
            }
        });
        ...
        createInstance.addOnSuccessListener(executor2, new OnSuccessListener() { // from class: com.google.firebase.messaging.FirebaseMessaging$$ExternalSyntheticLambda4
            ...
            public final void onSuccess(Object obj) {
                FirebaseMessaging.this.m112lambda$new$2$comgooglefirebasemessagingFirebaseMessaging((TopicsSubscriber) obj);
            }
        });
        executor2.execute(new Runnable() { // from class: com.google.firebase.messaging.FirebaseMessaging$$ExternalSyntheticLambda5
            ...
            @Override // java.lang.Runnable
            public final void run() {
                FirebaseMessaging.this.m113lambda$new$3$comgooglefirebasemessagingFirebaseMessaging();
            }
        });
    }

    /* renamed from: lambda$new$1$com-google-firebase-messaging-FirebaseMessaging */
    public /* synthetic */ void m111lambda$new$1$comgooglefirebasemessagingFirebaseMessaging() {
    ...
    public /* synthetic */ void m112lambda$new$2$comgooglefirebasemessagingFirebaseMessaging(TopicsSubscriber topicsSubscriber) {
        if (isAutoInitEnabled()) {
    ...
    public /* synthetic */ void m113lambda$new$3$comgooglefirebasemessagingFirebaseMessaging() {
    ...
    public Task<String> getToken() {
        ...
        this.initExecutor.execute(new Runnable() { // from class: com.google.firebase.messaging.FirebaseMessaging$$ExternalSyntheticLambda6
            ...
            @Override // java.lang.Runnable
            public final void run() {
                FirebaseMessaging.this.m109x6bb67082(taskCompletionSource);
            }
        });
    ...
    public /* synthetic */ void m109x6bb67082(TaskCompletionSource taskCompletionSource) {
        try {
    ...
    public Task<Void> deleteToken() {
        if (this.iid != null) {
            ...
            this.initExecutor.execute(new Runnable() { // from class: com.google.firebase.messaging.FirebaseMessaging$$ExternalSyntheticLambda9
                ...
                @Override // java.lang.Runnable
                public final void run() {
                    FirebaseMessaging.this.m107xd6d6bd74(taskCompletionSource);
                }
            });
            return taskCompletionSource.getTask();
            ...
            FcmExecutors.newNetworkIOExecutor().execute(new Runnable() { // from class: com.google.firebase.messaging.FirebaseMessaging$$ExternalSyntheticLambda10
                ...
                @Override // java.lang.Runnable
                public final void run() {
                    FirebaseMessaging.this.m108xd6605775(taskCompletionSource2);
                }
            });
    ...
    public /* synthetic */ void m107xd6d6bd74(TaskCompletionSource taskCompletionSource) {
        try {
    ...
    public /* synthetic */ void m108xd6605775(TaskCompletionSource taskCompletionSource) {
        try {
        ...
        try {
            return (String) Tasks.await(this.requestDeduplicator.getOrStartGetTokenRequest(defaultSenderId, new RequestDeduplicator.GetTokenRequest() { // from class: com.google.firebase.messaging.FirebaseMessaging$$ExternalSyntheticLambda8
                ...
                public final Task start() {
                    return FirebaseMessaging.this.m105xb9ac49c0(defaultSenderId, tokenWithoutTriggeringSync);
                }
            }));
    ...
    public /* synthetic */ Task m105xb9ac49c0(final String str, final Store.Token token) {
        return this.gmsRpc.getToken().onSuccessTask(this.fileExecutor, new SuccessContinuation() { // from class: com.google.firebase.messaging.FirebaseMessaging$$ExternalSyntheticLambda1
            ...
            @Override // com.google.android.gms.tasks.SuccessContinuation
            public final Task then(Object obj) {
                return FirebaseMessaging.this.m106xa77f119c(str, token, (String) obj);
            }
        });
    }

    /* renamed from: lambda$blockingGetToken$9$com-google-firebase-messaging-FirebaseMessaging */
    public /* synthetic */ Task m106xa77f119c(String str, Store.Token token, String str2) throws Exception {
        getStore(this.context).saveToken(getSubtype(), str, str2, this.metadata.getAppVersionCode());
        if (token == null || !str2.equals(token.token)) {
            m110lambda$new$0$comgooglefirebasemessagingFirebaseMessaging(str2);
        }
    ...
    public void m110lambda$new$0$comgooglefirebasemessagingFirebaseMessaging(String str) {
        if (FirebaseApp.DEFAULT_APP_NAME.equals(this.firebaseApp.getName())) {
    ...
    public class AutoInit {
        ...
        synchronized void initialize() {
            ...
            if (readEnabled == null) {
                EventHandler<DataCollectionDefaultChange> eventHandler = new EventHandler() { // from class: com.google.firebase.messaging.FirebaseMessaging$AutoInit$$ExternalSyntheticLambda0
                    {
                        FirebaseMessaging.AutoInit.this = this;
                    }

                    @Override // com.google.firebase.events.EventHandler
                    public final void handle(Event event) {
                        FirebaseMessaging.AutoInit.this.m114x1061f0b8(event);
                    }
                };
        ...
        public /* synthetic */ void m114x1061f0b8(Event event) {
            if (isEnabled()) {
