...
public class CrashlyticsReportPersistence {
    ...
    /* renamed from: $r8$lambda$Ef09-Fis7I_z-AXvERJDwHbq9g8 */
    public static /* synthetic */ boolean m93$r8$lambda$Ef09Fis7I_zAXvERJDwHbq9g8(File file, String str) {
        return isNormalPriorityEventFile(file, str);
    }

    /* renamed from: $r8$lambda$KEiHBBF_z04XQMHnQYJTj-31PpI */
    public static /* synthetic */ int m94$r8$lambda$KEiHBBF_z04XQMHnQYJTj31PpI(File file, File file2) {
    ...
    private int trimEvents(String str, int i) {
        List<File> sessionFiles = this.fileStore.getSessionFiles(str, new FilenameFilter() { // from class: com.google.firebase.crashlytics.internal.persistence.CrashlyticsReportPersistence$$ExternalSyntheticLambda2
            ...
            public final boolean accept(File file, String str2) {
                return CrashlyticsReportPersistence.m93$r8$lambda$Ef09Fis7I_zAXvERJDwHbq9g8(file, str2);
            }
        });
        Collections.sort(sessionFiles, new Comparator() { // from class: com.google.firebase.crashlytics.internal.persistence.CrashlyticsReportPersistence$$ExternalSyntheticLambda3
            @Override // java.util.Comparator
            public final int compare(Object obj, Object obj2) {
                return CrashlyticsReportPersistence.m94$r8$lambda$KEiHBBF_z04XQMHnQYJTj31PpI((File) obj, (File) obj2);
            }
        });
