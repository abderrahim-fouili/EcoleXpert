...
public final class Detector {
    ...
    private ResultPoint[] getBullsEyeCorners(Point point) throws NotFoundException {
        ...
        this.compact = i2 == 5;
        return expandSquare(new ResultPoint[]{new ResultPoint(point.getX() + 0.5f, point.getY() - 0.5f), new ResultPoint(point2.getX() + 0.5f, point2.getY() + 0.5f), new ResultPoint(point3.getX() - 0.5f, point3.getY() + 0.5f), new ResultPoint(point4.getX() - 0.5f, point4.getY() - 0.5f)}, (i * 2) - 3, this.nbCenterLayers * 2);
    }
