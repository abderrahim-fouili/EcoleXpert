...
public class SQLiteEventStore implements EventStore, SynchronizationGuard, ClientHealthMetricsStore {
    ...
    SQLiteDatabase getDb() {
        ...
        return (SQLiteDatabase) retryIfDbLocked(new Producer() { // from class: com.google.android.datatransport.runtime.scheduling.persistence.SQLiteEventStore$$ExternalSyntheticLambda25
            ...
            public final Object produce() {
                ...
                writableDatabase = schemaManager.getWritableDatabase();
    ...
    public /* synthetic */ Long m66x42ac2bf1(EventInternal eventInternal, TransportContext transportContext, SQLiteDatabase sQLiteDatabase) {
        if (isStorageAtLimit()) {
    ...
    public void recordFailure(Iterable<PersistedEvent> iterable) {
        if (iterable.iterator().hasNext()) {
            ...
            inTransaction(new Function() { // from class: com.google.android.datatransport.runtime.scheduling.persistence.SQLiteEventStore$$ExternalSyntheticLambda11
                ...
                @Override // com.google.android.datatransport.runtime.scheduling.persistence.SQLiteEventStore.Function
                public final Object apply(Object obj) {
                    return SQLiteEventStore.this.m68x9f560649(str, r3, (SQLiteDatabase) obj);
                }
            });
        }
    }
    ...
    public /* synthetic */ Object m68x9f560649(String str, String str2, SQLiteDatabase sQLiteDatabase) {
    ...
    public /* synthetic */ Object m67x70a49c2a(Cursor cursor) {
    ...
    public /* synthetic */ Boolean m61xca7e02ad(TransportContext transportContext, SQLiteDatabase sQLiteDatabase) {
        Long transportContextId = getTransportContextId(sQLiteDatabase, transportContext);
        if (transportContextId == null) {
            return false;
        }
    ...
    public /* synthetic */ List m62x21bf8b6a(TransportContext transportContext, SQLiteDatabase sQLiteDatabase) {
        Priority[] values;
    ...
    public /* synthetic */ Integer m60xf6f3aef7(long j, SQLiteDatabase sQLiteDatabase) {
    ...
    public /* synthetic */ Object m59xc84244d8(Cursor cursor) {
        while (cursor.moveToNext()) {
            int i = cursor.getInt(0);
    ...
    public /* synthetic */ Object m65x1b337a6a(List list, TransportContext transportContext, Cursor cursor) {
        while (cursor.moveToNext()) {
    ...
    public ClientMetrics loadClientMetrics() {
        ...
        return (ClientMetrics) inTransaction(new Function() { // from class: com.google.android.datatransport.runtime.scheduling.persistence.SQLiteEventStore$$ExternalSyntheticLambda0
            ...
            @Override // com.google.android.datatransport.runtime.scheduling.persistence.SQLiteEventStore.Function
            public final Object apply(Object obj) {
                return SQLiteEventStore.this.m64xdd9aea28(r2, hashMap, newBuilder, (SQLiteDatabase) obj);
            }
        });
    }
    ...
    public /* synthetic */ ClientMetrics m64xdd9aea28(String str, final Map map, final ClientMetrics.Builder builder, SQLiteDatabase sQLiteDatabase) {
    ...
    public /* synthetic */ ClientMetrics m63xda5bcb7e(Map map, ClientMetrics.Builder builder, Cursor cursor) {
        while (cursor.moveToNext()) {
    ...
    public /* synthetic */ Object m69x18ea3bd6(SQLiteDatabase sQLiteDatabase) {
