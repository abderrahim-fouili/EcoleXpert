...
public class CaptureManager {
    ...
    public class AnonymousClass1 implements BarcodeCallback {
        ...
        public void barcodeResult(final BarcodeResult barcodeResult) {
            ...
            CaptureManager.this.handler.post(new Runnable() { // from class: com.journeyapps.barcodescanner.CaptureManager$1$$ExternalSyntheticLambda0
                {
                    CaptureManager.AnonymousClass1.this = this;
                }

                @Override // java.lang.Runnable
                public final void run() {
                    CaptureManager.AnonymousClass1.this.m134xddc42d84(barcodeResult);
                }
            });
        }

        /* renamed from: lambda$barcodeResult$0$com-journeyapps-barcodescanner-CaptureManager$1 */
        public /* synthetic */ void m134xddc42d84(BarcodeResult barcodeResult) {
    ...
    public CaptureManager(Activity activity, DecoratedBarcodeView decoratedBarcodeView) {
        ...
        this.inactivityTimer = new InactivityTimer(activity, new Runnable() { // from class: com.journeyapps.barcodescanner.CaptureManager$$ExternalSyntheticLambda0
            ...
            @Override // java.lang.Runnable
            public final void run() {
                CaptureManager.this.m133lambda$new$0$comjourneyappsbarcodescannerCaptureManager();
            }
        });
        this.beepManager = new BeepManager(activity);
    }

    /* renamed from: lambda$new$0$com-journeyapps-barcodescanner-CaptureManager */
    public /* synthetic */ void m133lambda$new$0$comjourneyappsbarcodescannerCaptureManager() {
    ...
    protected void displayFrameworkBugMessageAndExit(String str) {
        ...
        builder.setPositiveButton(R.string.zxing_button_ok, new DialogInterface.OnClickListener() { // from class: com.journeyapps.barcodescanner.CaptureManager$$ExternalSyntheticLambda2
            ...
            public final void onClick(DialogInterface dialogInterface, int i) {
                CaptureManager.this.m131x170613e1(dialogInterface, i);
            }
        });
        builder.setOnCancelListener(new DialogInterface.OnCancelListener() { // from class: com.journeyapps.barcodescanner.CaptureManager$$ExternalSyntheticLambda3
            ...
            public final void onCancel(DialogInterface dialogInterface) {
                CaptureManager.this.m132x8c803a22(dialogInterface);
            }
        });
        builder.show();
    }

    /* renamed from: lambda$displayFrameworkBugMessageAndExit$1$com-journeyapps-barcodescanner-CaptureManager */
    public /* synthetic */ void m131x170613e1(DialogInterface dialogInterface, int i) {
        finish();
    }

    /* renamed from: lambda$displayFrameworkBugMessageAndExit$2$com-journeyapps-barcodescanner-CaptureManager */
    public /* synthetic */ void m132x8c803a22(DialogInterface dialogInterface) {
        finish();
    }
