...
public final class ViewKt {
    public static /* synthetic */ void $r8$lambda$nSDSBfPSk_T_inbpxeVYecbjWLE(Function0 function0) {
        m33postOnAnimationDelayed$lambda1(function0);
    }
    ...
    public static final Runnable postOnAnimationDelayed(View view, long j, final Function0<Unit> action) {
        ...
        Runnable runnable = new Runnable() { // from class: androidx.core.view.ViewKt$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                ViewKt.$r8$lambda$nSDSBfPSk_T_inbpxeVYecbjWLE(action);
            }
        };
    ...
    public static final void m33postOnAnimationDelayed$lambda1(Function0 action) {
        Intrinsics.checkNotNullParameter(action, "$action");
        action.invoke();
    }
