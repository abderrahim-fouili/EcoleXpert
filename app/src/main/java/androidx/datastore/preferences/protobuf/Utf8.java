        ...
        final String decodeUtf8Default(ByteBuffer byteBuffer, int i, int i2) throws InvalidProtocolBufferException {
            ...
            while (i < i3) {
                ...
                if (DecodeUtil.isOneByte(b2)) {
                    ...
                    int i9 = i + 3;
                    i += 4;
                    DecodeUtil.handleFourBytes(b2, b4, byteBuffer.get(i + 2), byteBuffer.get(i9), cArr, i5);
                    i5 += 2;
                }
            }
        ...
        String decodeUtf8(byte[] bArr, int i, int i2) throws InvalidProtocolBufferException {
            ...
            while (i < i3) {
                ...
                if (DecodeUtil.isOneByte(b2)) {
                    ...
                    int i9 = i + 3;
                    i += 4;
                    DecodeUtil.handleFourBytes(b2, b4, bArr[i + 2], bArr[i9], cArr, i5);
                    i5 += 2;
                }
            }
            return new String(cArr, 0, i5);
        ...
        String decodeUtf8(byte[] bArr, int i, int i2) throws InvalidProtocolBufferException {
            ...
            while (i < i3) {
                ...
                if (DecodeUtil.isOneByte(b2)) {
                    ...
                    int i9 = i + 3;
                    i += 4;
                    DecodeUtil.handleFourBytes(b2, UnsafeUtil.getByte(bArr, i6), UnsafeUtil.getByte(bArr, i + 2), UnsafeUtil.getByte(bArr, i9), cArr, i5);
                    i5 += 2;
                }
            }
            return new String(cArr, 0, i5);
