...
public final class LintKt {
    ...
    private static final <T> Flow<T> m1664catch(SharedFlow<? extends T> sharedFlow, Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> function3) {
        return FlowKt.m1656catch(sharedFlow, function3);
    }
