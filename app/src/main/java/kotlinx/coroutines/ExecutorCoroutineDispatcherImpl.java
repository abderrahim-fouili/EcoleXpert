...
public final class ExecutorCoroutineDispatcherImpl extends ExecutorCoroutineDispatcher implements Delay {
    ...
    public void mo1680scheduleResumeAfterDelay(long j, CancellableContinuation<? super Unit> cancellableContinuation) {
        Executor executor = getExecutor();
        ...
        if (scheduleBlock != null) {
            ...
            DefaultExecutor.INSTANCE.mo1680scheduleResumeAfterDelay(j, cancellableContinuation);
        }
    }
