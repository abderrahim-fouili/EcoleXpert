...
final class ReceiveChannel$onReceiveOrNull$1$registerSelectClause1$1<E, R> extends SuspendLambda implements Function2<ChannelResult<? extends E>, Continuation<? super R>, Object> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object obj, Object obj2) {
        return m1653invokeWpGqRn0(((ChannelResult) obj).m1649unboximpl(), (Continuation) obj2);
    }

    /* renamed from: invoke-WpGqRn0  reason: not valid java name */
    public final Object m1653invokeWpGqRn0(Object obj, Continuation<? super R> continuation) {
        return ((ReceiveChannel$onReceiveOrNull$1$registerSelectClause1$1) create(ChannelResult.m1637boximpl(obj), continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            Object m1649unboximpl = ((ChannelResult) this.L$0).m1649unboximpl();
            Throwable m1641exceptionOrNullimpl = ChannelResult.m1641exceptionOrNullimpl(m1649unboximpl);
            if (m1641exceptionOrNullimpl != null) {
                throw m1641exceptionOrNullimpl;
            }
            Object m1642getOrNullimpl = ChannelResult.m1642getOrNullimpl(m1649unboximpl);
            this.label = 1;
            obj = this.$block.invoke(m1642getOrNullimpl, this);
