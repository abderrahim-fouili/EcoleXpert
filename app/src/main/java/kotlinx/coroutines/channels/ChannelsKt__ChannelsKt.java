...
final /* synthetic */ class ChannelsKt__ChannelsKt {
    ...
    public static final <E> Object trySendBlocking(SendChannel<? super E> sendChannel, E e) {
        ...
        Object mo1632trySendJP2dKIU = sendChannel.mo1632trySendJP2dKIU(e);
        if (mo1632trySendJP2dKIU instanceof ChannelResult.Failed) {
            ...
            return ((ChannelResult) runBlocking$default).m1649unboximpl();
        }
        Unit unit = (Unit) mo1632trySendJP2dKIU;
    ...
    public static final <E> void sendBlocking(SendChannel<? super E> sendChannel, E e) {
        if (ChannelResult.m1647isSuccessimpl(sendChannel.mo1632trySendJP2dKIU(e))) {
            return;
        }
