...
public interface SendChannel<E> {
    ...
    Object mo1632trySendJP2dKIU(E e);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            ...
            if (ChannelResult.m1647isSuccessimpl(mo1632trySendJP2dKIU)) {
                return true;
            }
            Throwable m1641exceptionOrNullimpl = ChannelResult.m1641exceptionOrNullimpl(mo1632trySendJP2dKIU);
