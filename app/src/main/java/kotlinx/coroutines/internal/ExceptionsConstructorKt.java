...
public final class ExceptionsConstructorKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E e) {
        ...
        if (e instanceof CopyableThrowable) {
            try {
                ...
                m144constructorimpl = Result.m144constructorimpl(((CopyableThrowable) e).createCopy());
            } catch (Throwable th) {
                ...
                if (length == 2 && Intrinsics.areEqual(parameterTypes[0], String.class) && Intrinsics.areEqual(parameterTypes[1], Throwable.class)) {
                    return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$createSafeConstructor$$inlined$safeCtor$1
                        ...
                        public final Throwable invoke(Throwable th) {
                            ...
                            if (newInstance != null) {
                                m144constructorimpl = Result.m144constructorimpl((Throwable) newInstance);
                                if (Result.m150isFailureimpl(m144constructorimpl)) {
                                    m144constructorimpl = null;
                                }
                                return (Throwable) m144constructorimpl;
                            }
                    ...
                    return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$createSafeConstructor$$inlined$safeCtor$3
                        ...
                        public final Throwable invoke(Throwable th) {
                            ...
                            if (newInstance != null) {
                                ...
                                th3.initCause(th);
                                m144constructorimpl = Result.m144constructorimpl(th3);
                                if (Result.m150isFailureimpl(m144constructorimpl)) {
                                    m144constructorimpl = null;
                                }
                                return (Throwable) m144constructorimpl;
    ...
    private static final Function1<Throwable, Throwable> safeCtor(final Function1<? super Throwable, ? extends Throwable> function1) {
        return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$safeCtor$1
            ...
            public final Throwable invoke(Throwable th) {
                ...
                try {
                    Result.Companion companion = Result.Companion;
                    m144constructorimpl = Result.m144constructorimpl(function12.invoke(th));
                } catch (Throwable th2) {
                    Result.Companion companion2 = Result.Companion;
                    m144constructorimpl = Result.m144constructorimpl(ResultKt.createFailure(th2));
                }
    ...
    private static final int fieldsCountOrDefault(Class<?> cls, int i) {
        Integer m144constructorimpl;
        JvmClassMappingKt.getKotlinClass(cls);
        try {
            Result.Companion companion = Result.Companion;
            m144constructorimpl = Result.m144constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            m144constructorimpl = Result.m144constructorimpl(ResultKt.createFailure(th));
        }
        ...
        if (Result.m150isFailureimpl(m144constructorimpl)) {
            m144constructorimpl = valueOf;
        }
        return ((Number) m144constructorimpl).intValue();
    }
