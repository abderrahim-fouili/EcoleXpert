...
public final class TasksKt {
    public static /* synthetic */ void $r8$lambda$q0tXbLx0F1FkIBcyGUw0XIqaPjE(CompletableDeferred completableDeferred, Task task) {
        m1692asDeferredImpl$lambda0(completableDeferred, task);
    }
        ...
        if (task.isComplete()) {
            ...
            task.addOnCompleteListener(DirectExecutor.INSTANCE, new OnCompleteListener() { // from class: kotlinx.coroutines.tasks.TasksKt$$ExternalSyntheticLambda0
                ...
                public final void onComplete(Task task2) {
                    TasksKt.$r8$lambda$q0tXbLx0F1FkIBcyGUw0XIqaPjE(CompletableDeferred$default, task2);
                }
            });
        }
    ...
    public static final void m1692asDeferredImpl$lambda0(CompletableDeferred completableDeferred, Task task) {
        Exception exception = task.getException();
        if (exception == null) {
            if (task.isCanceled()) {
        ...
        task.addOnCompleteListener(DirectExecutor.INSTANCE, new OnCompleteListener() { // from class: kotlinx.coroutines.tasks.TasksKt$awaitImpl$2$1
            ...
            public final void onComplete(Task<T> task2) {
                ...
                if (exception2 == null) {
                    ...
                    cancellableContinuationImpl2.resumeWith(Result.m144constructorimpl(task2.getResult()));
                    return;
                }
                Result.Companion companion2 = Result.Companion;
                cancellableContinuationImpl2.resumeWith(Result.m144constructorimpl(ResultKt.createFailure(exception2)));
            }
        });
        if (cancellationTokenSource != null) {
