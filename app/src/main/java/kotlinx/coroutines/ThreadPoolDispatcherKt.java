...
public final class ThreadPoolDispatcherKt {
    public static /* synthetic */ Thread $r8$lambda$Hvo_A1RS2PU7rVE9OhBtvm0S7Js(int i, String str, AtomicInteger atomicInteger, Runnable runnable) {
        return m1624newFixedThreadPoolContext$lambda1(i, str, atomicInteger, runnable);
    }
    ...
    public static final ExecutorCoroutineDispatcher newFixedThreadPoolContext(final int i, final String str) {
        ...
        return ExecutorsKt.from((ExecutorService) Executors.newScheduledThreadPool(i, new ThreadFactory() { // from class: kotlinx.coroutines.ThreadPoolDispatcherKt$$ExternalSyntheticLambda0
            ...
            public final Thread newThread(Runnable runnable) {
                return ThreadPoolDispatcherKt.$r8$lambda$Hvo_A1RS2PU7rVE9OhBtvm0S7Js(i, str, atomicInteger, runnable);
            }
        }));
    }

    /* renamed from: newFixedThreadPoolContext$lambda-1 */
    public static final Thread m1624newFixedThreadPoolContext$lambda1(int i, String str, AtomicInteger atomicInteger, Runnable runnable) {
        if (i != 1) {
