...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo1680scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
    ...
    public static final Object m1616delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object delay = delay(m1617toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m1617toDelayMillisLRDsOJo(long j) {
        if (Duration.m1457compareToLRDsOJo(j, Duration.Companion.m1560getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1476getInWholeMillisecondsimpl(j), 1L);
        }
        return 0L;
    }
}
