...
public final class HandlerContext extends HandlerDispatcher implements Delay {
    ...
    public static /* synthetic */ void $r8$lambda$DzMoV5SnItMbaZ8MiIe3Ntrgpvs(HandlerContext handlerContext, Runnable runnable) {
        m1627invokeOnTimeout$lambda3(handlerContext, runnable);
    }
    ...
    public static final void m1627invokeOnTimeout$lambda3(HandlerContext handlerContext, Runnable runnable) {
    ...
    private final void cancelOnRejection(CoroutineContext coroutineContext, Runnable runnable) {
        ...
        Dispatchers.getIO().mo1679dispatch(coroutineContext, runnable);
    }
    ...
    public void mo1680scheduleResumeAfterDelay(long j, final CancellableContinuation<? super Unit> cancellableContinuation) {
