...
public final class HandlerDispatcherKt {
    ...
    public static /* synthetic */ void $r8$lambda$gp6JLGBkWOxUeE1_JLllkAXyyxM(CancellableContinuation cancellableContinuation, long j) {
        m1628postFrameCallback$lambda6(cancellableContinuation, j);
    }
    ...
    static {
        ...
        try {
            ...
            m144constructorimpl = Result.m144constructorimpl(new HandlerContext(asHandler(Looper.getMainLooper(), true), null, 2, null));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            m144constructorimpl = Result.m144constructorimpl(ResultKt.createFailure(th));
        }
        Main = Result.m150isFailureimpl(m144constructorimpl) ? null : m144constructorimpl;
    }
    ...
    public static final Object awaitFrame(Continuation<? super Long> continuation) {
        ...
        Dispatchers.getMain().mo1679dispatch(EmptyCoroutineContext.INSTANCE, new Runnable() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$awaitFrame$lambda-3$$inlined$Runnable$1
    ...
    public static final void postFrameCallback(Choreographer choreographer2, final CancellableContinuation<? super Long> cancellableContinuation) {
        choreographer2.postFrameCallback(new Choreographer.FrameCallback() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$$ExternalSyntheticLambda0
            ...
            public final void doFrame(long j) {
                HandlerDispatcherKt.$r8$lambda$gp6JLGBkWOxUeE1_JLllkAXyyxM(cancellableContinuation, j);
            }
        });
    }

    /* renamed from: postFrameCallback$lambda-6 */
    public static final void m1628postFrameCallback$lambda6(CancellableContinuation cancellableContinuation, long j) {
