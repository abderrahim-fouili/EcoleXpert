...
public final class AgentPremain {
    ...
    public static /* synthetic */ void m1654$r8$lambda$dZ6aaVgxuad4u6m9DEFCVZIc5g(Signal signal) {
        m1655installSignalHandler$lambda1(signal);
    }
    ...
    static {
        ...
        try {
            ...
            m144constructorimpl = Result.m144constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            m144constructorimpl = Result.m144constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = Result.m150isFailureimpl(m144constructorimpl) ? null : m144constructorimpl;
        ...
        try {
            Signal.handle(new Signal("TRAP"), new SignalHandler() { // from class: kotlinx.coroutines.debug.AgentPremain$$ExternalSyntheticLambda0
                public final void handle(Signal signal) {
                    AgentPremain.m1654$r8$lambda$dZ6aaVgxuad4u6m9DEFCVZIc5g(signal);
                }
            });
    ...
    public static final void m1655installSignalHandler$lambda1(Signal signal) {
