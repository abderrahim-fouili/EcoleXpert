...
public final class SupervisorKt {
    ...
    public static final /* synthetic */ Job m1622SupervisorJob(Job job) {
        return SupervisorJob(job);
    }

    /* renamed from: SupervisorJob$default */
    public static /* synthetic */ Job m1623SupervisorJob$default(Job job, int i, Object obj) {
        if ((i & 1) != 0) {
            job = null;
        }
        return m1622SupervisorJob(job);
    }
